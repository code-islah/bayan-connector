...
` +
    ...
    function Ki(e) {
      ...
      if (
        ...
        t === 27
          ...
          : (N = M ? cf(e.stateNode.nextSibling) : null);
      return !0;
    }
    function qi() {
      ((N = M = null), (P = !1));
      ...
      function f(e, t, n) {
        ...
        if (typeof t == `object` && t) {
          switch (t.$$typeof) {
            ...
            case ne:
              return ((t = L(t)), f(e, t, n));
          }
          if (le(t) || oe(t))
            return ((t = j(t, e.mode, n, null)), (t.return = e), t);
          ...
          switch (o.$$typeof) {
            case _:
              a: {
                ...
                o.type === y
                  ? ((c = j(o.props.children, e.mode, c, o.key)),
                    (c.return = e),
                    (e = c))
    ...
    function Ro(e, t, n) {
      ...
      if (((o = e.baseState), a === null)) e.memoizedState = o;
        ...
        if (
          (l === null ? (s = o) : (l.next = c),
          !Mr(o, e.memoizedState) && ((ic = !0), d && ((n = ga), n !== null)))
        )
          throw n;
        ((e.memoizedState = o),
          (e.baseState = s),
    ...
    function lc(e, t, n, r) {
      ...
      if (
        ...
        a === null
          ? (e !== null && Ca(t, null), no(), lo(t))
          : (Ca(t, a.cachePool), to(t, a), lo(t), (t.memoizedState = null));
    ...
    function vc(e, t, n, r, i) {
      if ((aa(t), t.stateNode === null)) {
        ...
        (typeof o == `object` && o && (a = F(o)),
          ...
          Ha(t),
          (o = n.contextType),
          (a.context = typeof o == `object` && o ? F(o) : mi),
          (a.state = t.memoizedState),
          ...
          a: {
            ...
            if (
              ...
              if (
                ...
                ((a = Ti(Error(i(424)), t)), Yi(a), (t = yc(e, t, r, n)));
                break a;
              } else {
    ...
    function xu() {
      if (q !== null) {
        ...
        else ((e = q), (Qi = Zi = null), ko(e), (R = null), (Pa = 0), (e = q));
            ...
            : (Y =
                t === rc
                  ...
                  : typeof t == `object` && t && typeof t.then == `function`
                    ...
                    : 1),
        (Bl = t),
        q === null && ((X = 1), Zs(e, Ti(t, e.current))));
    }
    function wu() {
      var e = io.current;
      return e === null
    ...
    function Pu(e, t, n, r) {
      ((Qi = Zi = null), ko(t), (R = null), (Pa = 0));
      var i = t.return;
      try {
        if (nc(e, i, t, n, J)) {
          ((X = 1), Zs(e, Ti(n, e.current)), (q = null));
          return;
        }
      } catch (t) {
    ...
    (ri(Xr, `onAnimationEnd`),
      ri(Zr, `onAnimationIteration`),
      ri(Qr, `onAnimationStart`),
      ri(`dblclick`, `onDoubleClick`),
      ri(`focusin`, `onFocus`),
      ri(`focusout`, `onBlur`),
      ri($r, `onTransitionRun`),
      ri(ei, `onTransitionStart`),
      ri(k, `onTransitionCancel`),
      ri(A, `onTransitionEnd`),
...
var We = S.createContext(!1),
  Ge = S.createContext({ isTransitioning: !1 });
Ge.displayName = `ViewTransition`;
var Ke = S.createContext(new Map());
...
var Xe = S.createContext({ outlet: null, matches: [], isDataRoute: !1 });
...
function rt(e, { relative: t } = {}) {
  ...
  let { basename: n, navigator: r } = S.useContext(Je),
...
function at() {
  return (
    ...
    S.useContext(Ye).location
  );
}
var ot = `You should call navigate() in a React.useEffect(), not when your component is first rendered.`;
function st(e) {
  S.useContext(Je).static || S.useLayoutEffect(e);
}
function ct() {
  let { isDataRoute: e } = S.useContext(Xe);
  return e ? kt() : lt();
}
function lt() {
  T(
  ...
  let e = S.useContext(He),
    { basename: t, navigator: n } = S.useContext(Je),
    { matches: r } = S.useContext(Xe),
    { pathname: i } = at(),
  ...
  return (
    ...
    S.useCallback(
      (r, s = {}) => {
        if ((te(o.current, ot), !o.current)) return;
        if (typeof r == `number`) {
          n.go(r);
          return;
        }
...
function ft(e, t, n) {
  ...
  let { navigator: r } = S.useContext(Je),
    { matches: i } = S.useContext(Xe),
    a = i[i.length - 1],
    o = a ? a.params : {},
    s = a ? a.pathname : `/`,
    c = a ? a.pathnameBase : `/`,
...
var mt = S.createElement(pt, null),
  ht = class extends S.Component {
    constructor(e) {
      (super(e),
        (this.state = {
          location: e.location,
      ...
      let t =
        e === void 0
          ...
          : S.createElement(
              ...
              S.createElement(Ze.Provider, {
                value: e,
                children: this.props.component,
              }),
            );
      return this.context ? S.createElement(_t, { error: e }, t) : t;
    }
  };
ht.contextType = We;
var gt = new WeakMap();
function _t({ children: e, error: t }) {
  let { basename: n } = S.useContext(Je);
  if (
    typeof t == `object` &&
    t &&
    `digest` in t &&
...
function vt({ routeContext: e, match: t, children: n }) {
  ...
  return (
    ...
    S.createElement(Xe.Provider, { value: e }, n)
  );
}
function yt(e, t = [], n) {
  let r = n?.state;
...
var At = {};
function jt(e, t, n) {
  !t && !At[e] && ((At[e] = !0), te(!1, n));
}
(S.useOptimistic, S.memo(Mt));
...
function Nt({ to: e, replace: t, state: n, relative: r }) {
  ...
  let { static: i } = S.useContext(Je);
  te(
    !i,
    `<Navigate> must not be used on the initial render in a <StaticRouter>. This is a no-op, but you should modify your code so the <Navigate> is only ever rendered in response to some user interaction or state change.`,
  );
  let { matches: a } = S.useContext(Xe),
    { pathname: o } = at(),
    s = ct(),
  ...
  return (
    ...
    h == null
      ...
      : S.createElement(
          Je.Provider,
          { value: c },
          S.createElement(Ye.Provider, { children: t, value: h }),
        )
  );
}
...
var Tn = /^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,
  En = S.forwardRef(function (
    ...
    return w && !v
      ? S.createElement(S.Fragment, null, ie, S.createElement(vn, { page: b }))
      : ie;
  });
En.displayName = `Link`;
var Dn = S.forwardRef(function (
  ...
  let u = ut(a, { relative: c.relative }),
    d = at(),
    f = S.useContext(Ue),
    { navigator: p, basename: m } = S.useContext(Je),
    h = f != null && Un(u) && o === !0,
...
var On = S.forwardRef(
  (
    ...
    let { unstable_useTransitions: h } = S.useContext(Je),
      g = In(),
      _ = Ln(s, { relative: l }),
...
var { toString: Gn } = Object.prototype,
  ...
  { iterator: qn, toStringTag: Jn } = Symbol,
  Yn = ((e) => (t) => {
    let n = Gn.call(t);
...
var vr = _r(),
  yr = vr.FormData === void 0 ? void 0 : vr.FormData,
  br = (e) => {
    let t;
    return (
      e &&
  ...
  xr = Xn(`URLSearchParams`),
  [Sr, Cr, wr, Tr] = [`ReadableStream`, `Request`, `Response`, `Headers`].map(
    Xn,
  ),
  Er = (e) =>
...
var kr =
  ...
  Ar = (e) => !$n(e) && e !== kr;
function jr() {
  let { caseless: e, skipUndefined: t } = (Ar(this) && this) || {},
    n = {},
    r = (r, i) => {
  ...
  for (let e = 0, t = arguments.length; e < t; e++)
    arguments[e] && Dr(arguments[e], r);
  return n;
}
var Mr = (e, t, n, { allOwnKeys: r } = {}) => (
    Dr(
      t,
      (t, r) => {
        n && ir(t)
  ...
  Nr = (e) => (e.charCodeAt(0) === 65279 && (e = e.slice(1)), e),
  Pr = (e, t, n, r) => {
...
function Xr(e) {
  return !!(e && ir(e.append) && e[Jn] === `FormData` && e[qn]);
}
var Zr = (e) => {
    let t = Array(10),
      n = (e, r) => {
  ...
  Qr = Xn(`AsyncFunction`),
  $r = (e) => e && (or(e) || ir(e)) && ir(e.then) && ir(e.catch),
  ei = ((e, t) =>
    e
      ? setImmediate
      : t
  ...
  k = {
    ...
    asap:
      typeof queueMicrotask < `u`
        ? queueMicrotask.bind(kr)
        : (typeof process < `u` && process.nextTick) || ei,
    isIterable: (e) => e != null && ir(e[qn]),
  },
...
function ii(e) {
  return k.isArray(e) && !e.some(ti);
}
var ai = k.toFlatObject(k, {}, null, function (e) {
...
function oi(e, t, n) {
  ...
  function l(e, n, i) {
    ...
    if (k.isReactNative(t) && k.isReactNativeBlob(e))
      return (t.append(ri(i, n, a), c(e)), !1);
    ...
    return ti(e) ? !0 : (t.append(ri(i, n, a), c(e)), !1);
  }
  let u = [],
    d = Object.assign(ai, {
      defaultVisitor: l,
...
var li = ci.prototype;
((li.append = function (e, t) {
  this._pairs.push([e, t]);
}),
  (li.toString = function (e) {
    let t = e
      ? function (t) {
          return e.call(this, t, si);
        }
      : si;
    return this._pairs
      .map(function (e) {
...
var fi = class {
  ...
  mi = {
    isBrowser: !0,
    classes: {
      URLSearchParams: typeof URLSearchParams < `u` ? URLSearchParams : ci,
  ...
  bi = (gi && window.location.href) || `http://localhost`,
  j = { ...hi, ...mi };
function xi(e, t) {
  return oi(e, new j.classes.URLSearchParams(), {
    ...
    return (
      ...
      s
        ...
        : ((!r[a] || !k.isObject(r[a])) && (r[a] = []),
          t(e, n, r[a], i) && k.isArray(r[a]) && (r[a] = Ci(r[a])),
          !o)
    );
  }
...
var Ei = {
  ...
  transformRequest: [
    function (e, t) {
      ...
      return i || r ? (t.setContentType(`application/json`, !1), Ti(e)) : e;
    },
  ],
  transformResponse: [
    function (e) {
      let t = this.transitional || Ei.transitional,
...
var Li = class {
  ...
  set(e, t, n) {
    ...
    else if (k.isString(e) && (e = e.trim()) && !Ni(e)) a(Oi(e), t);
  ...
  has(e, t) {
    if (((e = Ai(e)), e)) {
      let n = k.findKey(this, e);
      return !!(n && this[n] !== void 0 && (!t || Pi(this, this[n], n, t)));
    }
    return !1;
  }
  delete(e, t) {
    ...
    function i(e) {
      if (((e = Ai(e)), e)) {
        let i = k.findKey(n, e);
        i && (!t || Pi(n, n[i], i, t)) && (delete n[i], (r = !0));
      }
    }
  ...
  clear(e) {
    ...
    for (; n--; ) {
      let i = t[n];
      (!e || Pi(this, this[i], i, e, !0)) && (delete this[i], (r = !0));
    }
    return r;
  }
  normalize(e) {
    ...
    return (
      k.forEach(this, (r, i) => {
        ...
        let o = e ? Fi(i) : String(i).trim();
        (o !== i && delete t[i], (t[o] = ji(r)), (n[o] = !0));
      }),
      this
    );
  }
...
`);
  ...
  static accessor(e) {
    let t = (this[ki] = this[ki] = { accessors: {} }).accessors,
      n = this.prototype;
    function r(e) {
      let r = Ai(e);
      t[r] || (Ii(n, e), (t[r] = !0));
...
(Li.accessor([
  ...
  k.reduceDescriptors(Li.prototype, ({ value: e }, t) => {
...
function Yi(e, t, n) {
  let r = !qi(t);
  return e && (r || n == 0) ? Ji(e, t) : t;
}
var Xi = (e) => (e instanceof Li ? { ...e } : e);
function Zi(e, t) {
  t ||= {};
  let n = {};
  function r(e, t, n, r) {
...
var Qi = (e) => {
    ...
    if (
      ...
      (r && k.isFunction(r) && (r = r(t)), r || (r !== !1 && Gi(t.url)))
    ) {
      let e = i && a && Ki.read(a);
      e && o.set(i, e);
    }
    ...
    function (e) {
      return new Promise(function (t, n) {
        ...
        (`onloadend` in h
          ...
          c && (([d, p] = Hi(c, !0)), h.addEventListener(`progress`, d)),
          s &&
            h.upload &&
            (([u, f] = Hi(s)),
          ...
          (r.cancelToken || r.signal) &&
            ((l = (t) => {
              h &&= (n(!t || t.type ? new M(null, e, h) : t), h.abort(), null);
            }),
      ...
      let n = new AbortController(),
        ...
        i = function (e) {
          if (!r) {
            ...
            n.abort(
              t instanceof A ? t : new M(t instanceof Error ? t.message : t),
            );
          }
        },
        a =
  ...
  na = async function* (e, t) {
    for await (let n of ra(e)) yield* ta(n, t);
  },
  ra = async function* (e) {
  ...
  aa = 64 * 1024,
  { isFunction: F } = k,
  oa = (({ Request: e, Response: t }) => ({ Request: e, Response: t }))(
    k.global,
  ),
  { ReadableStream: sa, TextEncoder: ca } = k.global,
  la = (e, ...t) => {
    try {
      return !!e(...t);
    } catch {
  ...
  ua = (e) => {
    e = k.merge.call({ skipUndefined: !0 }, oa, e);
    let { fetch: t, Request: n, Response: r } = e,
      i = t ? F(t) : typeof fetch == `function`,
      a = F(n),
      o = F(r);
    if (!i) return !1;
    let s = i && F(sa),
      ...
      u = o && s && la(() => k.isReadableStream(new r(``).body)),
      d = { stream: u && ((e) => e.body) };
    i &&
    ...
    return async (e) => {
      ...
      let S = ea([c, f && f.toAbortSignal()], m),
        C = null,
        w =
          S &&
          S.unsubscribe &&
      ...
      try {
        ...
        _ ||= `text`;
        let T = await d[k.findKey(d, _) || `text`](f, e);
        return (
          !m && w && w(),
          await new Promise((t, n) => {
            N(t, n, {
              data: T,
              headers: Li.from(f.headers),
              status: f.status,
        ...
        throw (
          ...
          t && t.name === `TypeError` && /Load failed|fetch/i.test(t.message)
            ? Object.assign(
                new A(`Network Error`, A.ERR_NETWORK, e, C, t && t.response),
                { cause: t.cause || t },
              )
            : A.from(t, t && t.code, e, C, t && t.response)
        );
      }
    };
  },
  ...
  da = (e) => {
    ...
    for (; o--; )
      ((s = a[o]),
        (c = l.get(s)),
        c === void 0 && l.set(s, (c = o ? new Map() : ua(t))),
        (l = c));
    return c;
  };
da();
var fa = { http: null, xhr: $i, fetch: { get: da } };
k.forEach(fa, (e, t) => {
  if (e) {
    try {
...
var pa = (e) => `- ${e}`,
  ma = (e) => k.isFunction(e) || e === null || e === !1;
function ha(e, t) {
  e = k.isArray(e) ? e : [e];
  let { length: n } = e,
    r,
  ...
  for (let o = 0; o < n; o++) {
    ...
    if (
      ((i = r),
      !ma(r) && ((i = fa[(n = String(r)).toLowerCase()]), i === void 0))
    )
...
var ga = { getAdapter: ha, adapters: fa };
function _a(e) {
  if (
        ...
        function (t) {
          return (
            zi(t) ||
              ...
              t &&
                t.response &&
                ((t.response.data = Ri.call(
                  e,
                  e.transformResponse,
                  t.response,
                )),
                (t.response.headers = Li.from(t.response.headers)))),
            Promise.reject(t)
          );
        },
      )
...
var Ca = { assertOptions: Sa, validators: ba },
  wa = Ca.validators,
  Ta = class {
    constructor(e) {
      ((this.defaults = e || {}),
...
` + n)
    ...
    _request(e, t) {
      ...
      (n !== void 0 &&
        Ca.assertOptions(
          n,
          {
            ...
            legacyInterceptorReqResOrdering: wa.transitional(wa.boolean),
          },
          !1,
        ),
        r != null &&
        ...
        Ca.assertOptions(
          t,
          {
            baseUrl: wa.spelling(`baseURL`),
            withXsrfToken: wa.spelling(`withXSRFToken`),
          },
          !0,
        ),
      ...
      (i &&
        ...
        (t.headers = Li.concat(a, i)));
      let o = [],
        s = !0;
      this.interceptors.request.forEach(function (e) {
        if (typeof e.runWhen == `function` && e.runWhen(t) === !1) return;
        s &&= e.synchronous;
        let n = t.transitional || pi;
    ...
    getUri(e) {
      return (
        ...
        di(
          Yi(e.baseURL, e.url, e.allowAbsoluteUrls),
          e.params,
          e.paramsSerializer,
        )
      );
...
(k.forEach([`delete`, `get`, `head`, `options`], function (e) {
  Ta.prototype[e] = function (t, n) {
    return this.request(
      Zi(n || {}, { method: e, url: t, data: (n || {}).data }),
    );
  };
}),
...
function Aa(e) {
  let t = new Ta(e),
    n = Wn(Ta.prototype.request, t);
  return (
    k.extend(n, Ta.prototype, t, { allOwnKeys: !0 }),
...
((L.Axios = Ta),
  ...
  (L.mergeConfig = Zi),
  (L.AxiosHeaders = Li),
  (L.formToJSON = (e) => wi(k.isHTMLForm(e) ? new FormData(e) : e)),
  (L.getAdapter = ga.getAdapter),
  (L.HttpStatusCode = ka),
  (L.default = L));
var ja = _(),
  Ma = L.create({ baseURL: `http://localhost:3434/api` });
Ma.interceptors.request.use((e) => {
...
var Na = o((e) => {
  ...
  Fa = ({ children: e }) => {
    let [t, n] = (0, S.useState)(null),
      ...
      a = async () => {
        ...
        try {
          n((await Ma.get(`/auth/me`)).data.user);
        } catch (e) {
          (console.error(`Failed to load user:`, e), n(null));
        } finally {
          i(!1);
        }
      };
    return (
      ...
      (0, R.jsx)(Pa.Provider, {
        value: { user: t, setUser: n, loading: r, loadUser: a },
        children: e,
      })
    );
  },
  Ia = ({ children: e }) => {
    let { user: t, loading: n } = (0, S.useContext)(Pa);
    return n
      ? (0, R.jsx)(`div`, {
          className: `h-screen w-full mt-15 flex justify-center items-center`,
      ...
      : t
        ? e
        : (0, R.jsx)(Nt, { to: `/login`, replace: !0 });
  },
  La = () =>
    (0, R.jsx)(`nav`, {
      className: `z-100 fixed left-0 top-0 w-full`,
      children: (0, R.jsxs)(`div`, {
        className: `flex justify-between items-center w-full px-1 bg-primary border-b-dark shadow`,
        children: [
          (0, R.jsx)(`div`, {
            children: (0, R.jsx)(En, {
              to: `/`,
      ...
      (o(!0),
        navigator.geolocation.getCurrentPosition(
          (e) => {
            ...
            fetch(
              `https://nominatim.openstreetmap.org/reverse?lat=${t}&lon=${n}&format=json`,
            )
              .then((e) => e.json())
              .then((e) => {
                (i(e.address.county), o(!1));
              })
              .catch((e) => {
                (console.error(e), o(!1));
              });
      ...
      onSubmit: async (t) => {
        ...
        try {
          ...
          let n = localStorage.getItem(`token`),
            i = await Ma.post(`/posts`, t, {
              headers: { Authorization: `Bearer ` + n },
            });
          i.data.success && (m(``), f(null), e(i.data.post), c(!1));
        } catch (e) {
          console.log(e);
        }
      },
          ...
          children: [
            (0, R.jsxs)(`div`, {
              ...
              children: [
                ...
                (0, R.jsx)(`div`, {
                  className: `absolute z-10 transition-all shadow-sm bg-sec/30 rounded backdrop-blur-sm flex gap-2 bottom-[-30px] duration-300 ${t ? `max-w-[300px]` : `max-w-0 pointer-events-none`}`,
                  children: [
                    { name: `Like`, emoji: `👍` },
                    { name: `Love`, emoji: `❤️` },
                    { name: `Care`, emoji: `🥰` },
      ...
      hover:scale-125`,
                ...
                (0, R.jsxs)(`button`, {
                  ...
                  children: [
                    (0, R.jsx)(`img`, {
                      className: `w-8`,
                      src: d ? `/SVGs/uploaded.svg` : `/SVGs/uploadIMG.svg`,
                      alt: `Upload`,
                    }),
                    (0, R.jsx)(`input`, {
                      onChange: (e) => {
  ...
  Ua = ({
    ...
    ((0, S.useEffect)(() => {
      ...
      (0, S.useEffect)(() => {
        let t = h.find((t) => t._id === e);
        (b(t.likes.length), C(t.comments.length));
        let n = t.likes.find((e) => e?.user === g?._id)?.emoji;
        v(n);
      }, [e, h, g]));
    let ee = async (t, n) => {
      ...
      m((t) => t.map((t) => (t._id === e ? { ...t, likes: i.data.likes } : t)));
      let a = i.data.likes.find((e) => e.user === g._id).emoji;
      v(a);
    };
    return (0, R.jsxs)(`div`, {
      className: `grid grid-cols-1 bg-gradient-1 justify-between pt-5 px-3 py-2 shadow-sm border-b-2 border-gray-300 ${t === e ? `fixed top-0 w-full h-full z-100 overflow-y-auto backdrop-blur-[100px]` : ``}`,
      children: [
        t &&
          (0, R.jsx)(`div`, {
        ...
        (0, R.jsxs)(`div`, {
          ...
          onClick: (e) => {
            (e.stopPropagation(),
              w(`/profile`, { state: { prof: l, posts: h } }));
          },
          children: [
            (0, R.jsx)(`div`, {
              className: `relative`,
            ...
            (0, R.jsxs)(`div`, {
              children: [
                (0, R.jsx)(`p`, { className: `text-dark`, children: c }),
                (0, R.jsx)(`p`, {
                  className: `text-darkSub font-light text-sm`,
                  children: `User`,
                }),
              ],
            }),
        ...
        (0, R.jsxs)(`div`, {
          ...
          children: [
            (0, R.jsxs)(`div`, {
              className: `whitespace-nowrap flex gap-2 left-0 top-10 mt-1`,
              children: [
                (0, R.jsxs)(`p`, {
                  className: `text-[10px] text-darkSub`,
                  children: [` `, p ? `Feeling ` + p + ` ,` : ``],
                }),
                (0, R.jsxs)(`p`, {
                  className: `text-[10px] text-darkSub`,
                  children: [
            ...
            (0, R.jsxs)(`div`, {
              children: [
                (0, R.jsx)(`h1`, {
                  className: `py-1 pt-2 text-dark font-extrabold text-xl`,
                  children: s.split(` `).slice(0, 4).join(` `) + `...`,
                }),
                (0, R.jsx)(`p`, {
                  className: `${t ? `` : `line-clamp-2`} text-darkSub text-sm`,
                  children: s,
                }),
              ],
            }),
        ...
        (0, R.jsxs)(`div`, {
          className: `flex pt-4 justify-between gap-1`,
          children: [
            (0, R.jsxs)(`div`, {
              ...
              children: [
                (0, R.jsxs)(`div`, {
                  ...
                  children: [
                    ...
                    y > 0 &&
                      (0, R.jsx)(`div`, {
                        className: `text-darkSub text-sm self-center`,
                        children: y,
                      }),
                  ],
                }),
                ...
                x > 0 &&
                  (0, R.jsx)(`div`, {
                    className: `text-compBl -indent-2 text-sm self-center`,
                    children: x,
                  }),
                r === e &&
                  (0, R.jsx)(Ha, {
  ...
  Wa = ({ closeComment: e, posts: t, id: n }) => {
          ...
          (e.preventDefault(),
            ...
            (async (e, t) => {
              (localStorage.getItem(`token`),
                i(
                  (await Ma.post(`/posts/${e}/comment`, { text: t })).data.post
                    .comments,
                ),
                o(``),
                c(!1));
    ...
    return (
      ...
      (0, R.jsxs)(`div`, {
        ...
        children: [
          a &&
            (0, R.jsx)(`div`, {
              className: `animate-bottom-to-top fixed inset-0 bg-sec z-1000 overlay-y-auto`,
              children: (0, R.jsx)(Wa, {
                user: e,
                posts: t,
                id: a,
...
function Ka() {
  return (0, R.jsxs)(S.Fragment, {
    children: [
      (0, R.jsx)(`h1`, { className: `h-[200px]`, children: `Friends` }),
      (0, R.jsx)(`div`, { className: `bg-dark`, children: `I love Allah` }),
    ],
  });
}
var qa = o((e, t) => {
...
var $a = (0, S.forwardRef)(function (e, t) {
  ...
  return S.createElement(
    ...
    S.createElement(`line`, { x1: `22`, y1: `2`, x2: `11`, y2: `13` }),
    S.createElement(`polygon`, { points: `22 2 15 22 11 13 2 9 22 2` }),
  );
});
(($a.propTypes = {
...
var eo = () => {
  let [e, t] = (0, S.useState)([
    ...
    [n, r] = (0, S.useState)(``);
  return (0, R.jsxs)(`div`, {
    className: `mt-14 conversation-container`,
    children: [
      (0, R.jsxs)(`div`, {
        className: `conversation-header`,
        children: [
          (0, R.jsx)(En, { to: `/profile`, children: `Profile` }),
          (0, R.jsx)(`h2`, { children: `John Doe` }),
        ],
      }),
      (0, R.jsx)(`div`, {
        ...
        children: e.map((e) =>
          (0, R.jsx)(
            `div`,
            { className: `message ${e.sender}`, children: e.text },
            e.id,
          ),
        ),
      }),
      (0, R.jsxs)(`form`, {
        onSubmit: (i) => {
          (i.preventDefault(),
            n.trim() &&
              (t([...e, { id: e.length + 1, text: n, sender: `me` }]), r(``)));
        },
        ...
        children: [
          ...
          (0, R.jsx)(`button`, {
            type: `submit`,
            children: (0, R.jsx)($a, { color: `#1C7898`, size: 20 }),
          }),
        ],
      }),
    ],
...
function to() {
  return (0, R.jsx)(`h1`, { className: `mt-14`, children: `Friends` });
}
function no() {
  let e = ct(),
    { user: t, setUser: n, loading: r } = (0, S.useContext)(Pa);
  return (0, R.jsxs)(`div`, {
    ...
    children: [
      ...
      (0, R.jsxs)(`div`, {
        ...
        children: [
          ...
          (0, R.jsx)(`span`, { className: `text-dark`, children: `Posts` }),
          (0, R.jsx)(`span`, {
            className: `text-dark`,
      ...
      (0, R.jsxs)(`p`, {
        className: `pb-5 text-center self-end text-compBl`,
        children: [`@Bayan Connector `, new Date().getFullYear()],
      }),
    ],
  });
}
function ro() {
  let e = ct(),
    { setUser: t } = (0, S.useContext)(Pa),
    [n, r] = (0, S.useState)({ email: ``, password: `` }),
    i = (e) => {
      let { type: t, value: n } = e.target;
      r((e) => ({ ...e, [t === `email` ? `email` : `password`]: n }));
    };
  return (0, R.jsx)(`div`, {
    className: `h-screen w-full p-3 grid`,
    children: (0, R.jsxs)(`form`, {
      className: `grid self-center gap-1 [&>input]:p-3`,
      onSubmit: async (r) => {
        r.preventDefault();
        try {
          let { data: r } = await Ma.post(`/auth/login`, n);
          (localStorage.setItem(`token`, r.token),
            r.success && (t(r.user), e(`/`)));
        } catch (e) {
      ...
      children: [
        (0, R.jsxs)(`h1`, {
          className: `text-xl pb-10 text-darkSub`,
          children: [
            `Let's Connect the`,
            (0, R.jsx)(`span`, {
              className: `font-bold text-compYl`,
              children: ` Eloquence`,
            }),
            ` of`,
            (0, R.jsx)(`span`, {
              className: `font-bold text-compBl`,
              children: ` Our Hearts`,
            }),
          ],
        }),
        ...
        (0, R.jsxs)(`div`, {
          className: `flex gap-1 [&>button]:flex-1`,
          children: [
            (0, R.jsx)(`button`, {
        ...
        (0, R.jsxs)(`p`, {
          ...
          children: [
            ...
            (0, R.jsx)(En, {
              to: `/register`,
              children: (0, R.jsx)(`span`, {
                className: `underline text-compYl`,
                children: ` Register`,
              }),
            }),
          ],
...
var io = () => {
    ...
    async function u(t) {
      if ((t.preventDefault(), e.password !== e.confirmPassword))
        return alert(`Password doesn't match!`);
      let r = new FormData();
      (r.append(`name`, e.name),
        r.append(`email`, e.email),
        r.append(`password`, e.password),
        r.append(`profileImage`, n),
        r.append(`birthDate`, o));
      try {
        let e = await Ma.post(`/auth/reg`, r);
        (localStorage.setItem(`token`, e.data.token),
          e.data.success && (window.location.href = `/`));
      } catch (e) {
        console.log(e);
      }
    }
  ...
  oo = 3600 * 24;
(oo * 7, ((oo * ao) / 12) * 3);
var so = Symbol.for(`constructDateFrom`);
function co(e, t) {
  return typeof e == `function`
    ? e(t)
    : e && typeof e == `object` && so in e
      ? e[so](t)
      : e instanceof Date
        ? new e.constructor(t)
        : new Date(t);
...
function uo(e, ...t) {
  let n = co.bind(null, e || t.find((e) => typeof e == `object`));
  return t.map(n);
}
function z(e, t) {
  let n = lo(e) - +lo(t);
  ...
  return (
    (0, S.useEffect)(() => {
      t?.user._id &&
        (async (e) => {
          try {
            let t = await Ma.get(`/auth/${e}`);
            (console.log(t),
              i(() =>
                po(new Date(), new Date(t.data.birthDate.split(`T`)[0])),
              ));
          } catch (e) {
            console.log(e);
          }
    ...
    console.log(r),
    (0, R.jsxs)(`div`, {
      className: `px-3 grid h-screen mt-20`,
      children: [
        (0, R.jsxs)(`div`, {
          className: `flex gap-3 py-2 h-min border-b border-b-[#b1c1d9] rounded`,
          children: [
            (0, R.jsx)(`img`, {
              className: `self-start w-15 rounded-full aspect-square outline-2 outline-[#b1c1d9] outline-offset-1 object-cover`,
              src: t?.user?.profileImage,
              alt: t.user.name,
            }),
            (0, R.jsx)(`p`, { className: `text-dark`, children: t.user.name }),
            (0, R.jsx)(`p`, { className: `text-darkSub`, children: `j` }),
          ],
        }),
        (0, R.jsx)(`div`, { children: `jjk` }),
      ],
    })
  );
};
    ...
    children: (0, R.jsx)(Fa, {
      children: (0, R.jsxs)(Cn, {
        children: [
          ...
          (0, R.jsxs)(It, {
            children: [
              (0, R.jsx)(Pt, { path: `/`, element: (0, R.jsx)(Ga, {}) }),
              (0, R.jsx)(Pt, { path: `/friends`, element: (0, R.jsx)(Ka, {}) }),
              (0, R.jsx)(Pt, {
                path: `/conversations`,
                element: (0, R.jsx)(eo, {}),
              }),
              ...
              (0, R.jsx)(Pt, {
                path: `/settings`,
                element: (0, R.jsx)(Ia, { children: (0, R.jsx)(no, {}) }),
              }),
              (0, R.jsx)(Pt, { path: `/login`, element: (0, R.jsx)(ro, {}) }),
              (0, R.jsx)(Pt, {
                path: `/register`,
                element: (0, R.jsx)(io, {}),
              }),
              (0, R.jsx)(Pt, { path: `/profile`, element: (0, R.jsx)(B, {}) }),
            ],
          }),
        ],
      }),
...
(0, ja.createRoot)(document.getElementById(`root`)).render(
  (0, R.jsx)(S.StrictMode, { children: (0, R.jsx)(V, {}) }),
);
